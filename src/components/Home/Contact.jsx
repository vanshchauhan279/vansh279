            ...
            Let's <span className="text-indigo-700">Build Something Amazing Together</span>
                ...
                <form className="mt-12" >
                    ...
                    <input
                      ...
                      placeholder="chauhanvansh279@gmail.com" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                    </div>
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+91 8373976062</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">chauhanvansh279@gmail.com</span>
                    </p>
                </div>
                ...
                <div className="mt-6 w-80 md:mt-8">
                    ...
                    <div className="flex mt-4 -mx-1.5 ">
                        <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://twitter.com/VanshCh30252307" target='_blank'>
                        ...
                        <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.linkedin.com/in/vanshchauhan279/" target='_blank'>
                        ...
                        <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.instagram.com/" target='_blank'>
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
